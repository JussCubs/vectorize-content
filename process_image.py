...
def process_image(image_path, output_name="processed_image.png"):
    ...
    # Apply final brightness boost (+5%) to correct darkness
    enhancer = ImageEnhance.Brightness(img_gray)
    img_gray = enhancer.enhance(1.05)  # Small tweak to match Figma

    enhancer = ImageEnhance.Contrast(img_gray)
    img_gray = enhancer.enhance(1.6)  # Keep contrast sharp
